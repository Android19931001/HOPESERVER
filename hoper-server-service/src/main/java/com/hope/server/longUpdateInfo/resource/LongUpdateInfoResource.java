package com.hope.server.longUpdateInfo.resource;
...
import com.hope.server.longUpdateInfo.service.impl.LongUpdateInfoServiceImpl;
...
@RestController
@RequestMapping("/api")
public class LongUpdateInfoResource extends BaseRes {
